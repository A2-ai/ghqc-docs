...
- the target project directory is resolved from `here::here()`
...
- once the server responds, R opens `http://localhost:<port>` in your browser
...
- startup waits until the local server is reachable, then opens the browser
