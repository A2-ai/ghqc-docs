...
### 1. Install `ghqc`
    <Tabs syncKey="rv">
        ...
        <TabItem label = "rv">
            <Steps>
            1. Add a repository containing `ghqc` and `ghqc.app` to the **start** of the `repositories` field in the `rproject.toml`
                ```toml ins={6}
                // rproject.toml
                [project]
                name = "ghqc example"
        ...
        <TabItem label = "1. INSTALL">
            ...
            <Steps>
                1. Set the installation destination directory
                    ...
                    It is highly recommended to input `y` to install to the default location.
