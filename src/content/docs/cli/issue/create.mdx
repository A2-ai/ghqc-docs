...
optionally assign reviewers, and add any relevant file or QC references before posting the issue to GitHub.
...
#### 5. Add Relevant Files or QC References

After reviewers, `ghqc` asks whether you want to add [relevant files](../../../concepts/relevant-files). The default is **No**.
...
| `--previous-qc` | Previous QC issue URL, with optional `::description`. |
...
| `Previous QC` | A prior QC for the same or related work. It is also treated as blocking. |
