...
The Record tab generates a PDF QC record for one or more milestones. It is designed for assembling the final review package: selecting milestones, 
optionally adding context PDFs, previewing the result, and writing the finished file to disk.
