...
relevant files, and reviewers to selected files. 
...
Clicking **Create New QC** opens a modal with four tabs and a live preview card on the right. The preview updates as you fill in the issue details.
...
<Tabs>
  ...
  <TabItem label="Type Selection">
    ...
    - **Previous QC** — a prior QC of the same or similar work; treated as blocking
