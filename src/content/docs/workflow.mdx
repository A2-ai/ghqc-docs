...
reviewed and edited until all parties agree the script has not more changes to be made. Then the QC is approved. 
...
### Milestones
As is discussed [below](#issues) in more detail, Github Issues are the core unit of the QC. Milestones serve as an 
organizational structure for the QC. Milestones group related issues under common goals or timelines, such as a project phase.
...
* Commit of interest: When issues/comments are created, the commit of interested is included in the body.
* File content links: Links to the file content in GitHub at the commit of interest
* Checklists: Checklists for which the files must be reviewed against
