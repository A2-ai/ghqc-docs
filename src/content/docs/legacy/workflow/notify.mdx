...
At its core, the Notify app allows users to:
...
Below is a screenshot of the app on open. You can see it is similar to the mock UI above, where you are able to filter the issues based on milestones,
select issues, and show the file difference, but it also provides many additional useful features.

![](../../../../assets/legacy/workflow/notify_app_open.png)
...
![](../../../../assets/legacy/workflow/notify_app_compare.png)
...
![](../../../../assets/legacy/workflow/notify_app_preview.png)
